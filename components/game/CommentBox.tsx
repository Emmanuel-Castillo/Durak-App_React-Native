...
const CommentBox = () => {
  ...
  return (
    <View
      className={"flex-1 flex-row items-center bg-amber-900 overflow-hidden"}
    >
      <TouchableOpacity
        className={"bg-amber-500 h-full p-2 justify-center"}
      ...
      <Animated.Text
        numberOfLines={2}
        className={"max-w-[90%] text text-lg text-wrap px-2"}
