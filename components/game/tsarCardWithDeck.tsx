  ...
  return (
    <View className={"relative"}>
      <View className={"z-10 relative"}>
        ...
        <Text
          className={
            "absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text text-2xl"
          }
        >
          {deckLength}
        </Text>
      ...
      <View
        className={
          "absolute rotate-90 right-0 bottom-1/2 transform translate-y-1/2 -translate-x-1/4"
        }
      >
